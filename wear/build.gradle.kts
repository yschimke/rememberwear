...
dependencies {
    ...
    implementation(libs.gms.playservicesmaps)
    implementation(libs.gms.playserviceswearable)
    implementation(libs.google.maps)
    implementation(libs.dagger.hiltandroid)
    implementation(libs.maps.androidmapsutilsv3)
    implementation(libs.maps.mapsv3ktx)
    ...
    debugImplementation(libs.wear.tilesrenderer)
